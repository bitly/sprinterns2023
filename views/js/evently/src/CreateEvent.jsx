  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let res = await fetch("http://localhost:3000/api/events/", {
        ...
        mode: "no-cors", 
        body: JSON.stringify({
        event_title: EventTitle, date: DateForm, time: TimeForm, location: LocationForm, host_name: HostName, description: DescriptionForm, contact_info: ContactForm, public_private: PublicPrivate, max_attendees: parseInt(AttendeesForm), image_file: fileName
        }),
    });
    console.log(res)
      ...
      <div className="wrapper"> 
        <div className = "container">
          <div className = "form-container">
            ...
            <fieldset className = "input-box-fieldset"> {/* Creates box around the text and input box */}
              ...
              <input value={EventTitle} className = "input-boxes" onChange={(e) => {
                console.log(e.target.value) //COMMENT THIS OUT <-------------------------------------------------------------
          ...
          <div className='upload-container'>
            ...
            <fieldset style={{ backgroundColor: 'rgba(217, 217, 217)', padding: '25px'}}> 
